...
################################################################################
        ...
        jalisco_mc_2018_SeaRevocado_2022_distritos <- jalisco_presidencia_2018_revocacion_distritos %>% ggplot(aes(x= p_mc_2018, y=p_revoque))+
          geom_point(size = 1.5, color = "orange")+
          geom_smooth(method = lm, se = FALSE, color= "black", linetype = "dashed") +
          labs(x="Votos a Presidencia por el MC, 2018 (%)",
               y="Votos para que AMLO sea Revocado de la Presidencia, 2022 (%)",
               title="Votos a Presidencia por el MC, 2018 (%) vs \nVotos para que AMLO sea Revocado de la presidencia, 2022(%)",
               subtitle="Por Distrito - Jalisco", caption = "José Ahumada Castillo @AhumadaReal \n  Fuente: (https://computos2018.ine.mx, https://computosrm2022.ine.mx/)") +
          theme_economist()
...
###############################################################################
        ...
        nl_MORENA_2018_SeQuede_2022_distritos <- nl_presidencia_2018_revocacion_distritos %>% ggplot(aes(x= p_morena_2018, y=p_siga))+
          ...
          labs(x="Votos a Presidencia por Morena, 2018 (%) - Nacional",
               ...
               subtitle="Por Distrito - Nuevo León", caption = "José Ahumada Castillo @AhumadaReal \n  Fuente: (https://computos2018.ine.mx, https://computosrm2022.ine.mx/)") +
          theme_economist()
        ...
        nl_pri_2018_SeQuede_2022_distritos <- nl_presidencia_2018_revocacion_distritos %>% ggplot(aes(x= p_pri_2018, y=p_siga))+
          geom_point(size = 1.5, color = "red")+
          geom_smooth(method = lm, se = FALSE, color= "black", linetype = "dashed") +
          labs(x="Votos a Presidencia por el PRI, 2018 (%)",
               y="Votos para que AMLO Siga en la Presidencia, 2022 (%)",
               title="Votos a Presidencia por el PRI, 2018 (%)vs \nVotos para que AMLO Siga en la Presidencia, 2022 (%)",
               subtitle="Por Distrito - Nuevo León", caption = "José Ahumada Castillo @AhumadaReal \n  Fuente: (https://computos2018.ine.mx, https://computosrm2022.ine.mx/)") +
          theme_economist()
        ...
        nl_prd_2018_SeQuede_2022_distritos <- nl_presidencia_2018_revocacion_distritos %>% ggplot(aes(x= p_prd_2018, y=p_siga))+
          geom_point(size = 1.5, color = "gold3")+
          geom_smooth(method = lm, se = FALSE, color= "black", linetype = "dashed") +
          labs(x="Votos a Presidencia por el PRD, 2018 (%)",
               y="Votos para que AMLO Siga en la Presidencia, 2022 (%)",
               title="Votos a Presidencia por el PRD, 2018 (%) vs \n Votos para que AMLO Siga en la Presidencia, 2022 (%)",
               subtitle="Por Distrito - Nuevo León", caption = "José Ahumada Castillo @AhumadaReal \n  Fuente: (https://computos2018.ine.mx, https://computosrm2022.ine.mx/)") +
          theme_economist()
        ...
        nl_prd_2018_SeaRevocado_2022_distritos <- nl_presidencia_2018_revocacion_distritos %>% ggplot(aes(x= p_prd_2018, y=p_revoque))+
          ...
          labs(x="Votos a Presidencia por el PRD, 2018 (%)",
               y="Votos para que AMLO sea Revocado de la Presidencia, 2022 (%)",
               title="Votos a Presidencia por el PRD, 2018 (%) vs \Votos para que AMLO sea Revocado de la Presidencia, 2022(%)",
               subtitle="Por Distrito - Nuevo León", caption = "José Ahumada Castillo @AhumadaReal \n  Fuente: (https://computos2018.ine.mx, https://computosrm2022.ine.mx/)") +
          theme_economist()
        ...
        nl_pvem_2018_SeQuede_2022_distritos <- nl_presidencia_2018_revocacion_distritos %>% ggplot(aes(x= p_pvem_2018, y=p_siga))+
          geom_point(size = 1.5, color = "green")+
          geom_smooth(method = lm, se = FALSE, color= "black", linetype = "dashed") +
          labs(x="Votos a Presidencia por el PVEM, 2018 (%)",
               y="Votos para que AMLO Siga en la Presidencia, 2022 (%)",
               title="Votos a Presidencia por el PVEM, 2018 (%) vs \nVotos para que AMLO Siga en la Presidencia, 2022(%)",
               subtitle="Por Distrito - Nuevo León", caption = "José Ahumada Castillo @AhumadaReal \n  Fuente: (https://computos2018.ine.mx, https://computosrm2022.ine.mx/)") +
          theme_economist()
        ...
        nl_pt_2018_SeQuede_2022_distritos <- nl_presidencia_2018_revocacion_distritos %>% ggplot(aes(x= p_pt_2018, y=p_siga))+
          geom_point(size = 1.5, color = "red3")+
          geom_smooth(method = lm, se = FALSE, color= "black", linetype = "dashed") +
          labs(x="Votos a Presidencia por el PT, 2018 (%)",
               y="Votos para que AMLO Siga en la Presidencia, 2022 (%)",
               title="Votos a Presidencia por el PT, 2018 (%) vs \nVotos para que AMLO Siga en la Presidencia, 2022 (%)",
               subtitle="Por Distrito - Nuevo León", caption = "José Ahumada Castillo @AhumadaReal \n  Fuente: (https://computos2018.ine.mx, https://computosrm2022.ine.mx/)") +
          theme_economist()
        ...
        ggsave("outputs/NL_mc_2018_SeQuede_2022_distritos.png",
               device = "png",
               height = 15,
               width = 20,
               units = "cm")
        ...
        c_MORENA_2018_SeQuede_2022_distritos <- c_presidencia_2018_revocacion_distritos %>% ggplot(aes(x= p_morena_2018, y=p_siga))+
          ...
          labs(x="Votos a Presidencia por Morena, 2018 (%) - Nacional",
               y="Votos para que AMLO Siga en la Presidencia, 2022 Nacional(%)",
               title="Votos a Presidencia por Morena, 2018 (%) - Nacional vs \nVotos para que AMLO Siga en la Presidencia, 2022 Nacional(%)",
               subtitle="Por Distrito - CDMX", caption = "José Ahumada Castillo @AhumadaReal \n  Fuente: (https://computos2018.ine.mx, https://computosrm2022.ine.mx/)") +
          theme_economist()
        ...
        ggsave("outputs/c_pan_2018_SeaRevocado_2022_distritos.png",
               device = "png",
               height = 15,
               width = 20,
               units = "cm")
        ...
        nl_pri_2018_SeQuede_2022_distritos <- c_presidencia_2018_revocacion_distritos %>% ggplot(aes(x= p_pri_2018, y=p_siga))+
          geom_point(size = 1.5, color = "red")+
          geom_smooth(method = lm, se = FALSE, color= "black", linetype = "dashed") +
          labs(x="Votos a Presidencia por el PRI, 2018 (%)",
               y="Votos para que AMLO Siga en la Presidencia, 2022 (%)",
        ...
        ggsave("outputs/c_mc_2018_SeQuede_2022_distritos.png",
               device = "png",
               height = 15,
               width = 20,
               units = "cm")
        ...
        ggsave("outputs/c_mc_2018_SeaRevocado_2022_distritos.png",
               device = "png",
               height = 15,
               width = 20,
               units = "cm")
        ...
        y_MORENA_2018_SeQuede_2022_distritos <- y_presidencia_2018_revocacion_distritos %>% ggplot(aes(x= p_morena_2018, y=p_siga))+
          ...
          labs(x="Votos a Presidencia por Morena, 2018 (%) - Nacional",
               y="Votos para que AMLO Siga en la Presidencia, 2022 Nacional(%)",
               title="Votos a Presidencia por Morena, 2018 (%) - Nacional vs \nVotos para que AMLO Siga en la Presidencia, 2022 Nacional(%)",
               subtitle="Por Distrito - Yucatán", caption = "José Ahumada Castillo @AhumadaReal \n  Fuente: (https://computos2018.ine.mx, https://computosrm2022.ine.mx/)") +
          theme_economist()
