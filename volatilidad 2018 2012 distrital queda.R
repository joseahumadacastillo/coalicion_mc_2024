...
################################################################################
  ...
  ggplot(long_variaciones_2018_2012, aes(x = variable, y = value)) +            # Applying ggplot function
    geom_boxplot(aes(fill=variable, outlier.colour = "red")) +    
    geom_jitter(color="black", size=0.4, alpha=0.9) +
    coord_flip()
    #geom_sina()
    
    hist(variaciones_2018_2012$variacion_mc_presidencial_2018_2012)
  hist(variaciones_2018_2012$variacion_pvem_presidencial_2018_2012)
  hist(variaciones_2018_2012$variacion_pan_presidencial_2018_2012)
  hist(variaciones_2018_2012$variacion_nva_a_presidencial_2018_2012)
  
  sd(variaciones_2018_2012$variacion_mc_presidencial_2018_2012, na.rm = T)
  sd(variaciones_2018_2012$variacion_pvem_presidencial_2018_2012, na.rm = T)
  sd(variaciones_2018_2012$variacion_pan_presidencial_2018_2012, na.rm = T)
  sd(variaciones_2018_2012$variacion_nva_a_presidencial_2018_2012, na.rm = T)
  
  mean(variaciones_2018_2012$variacion_mc_presidencial_2018_2012, na.rm = T)
  mean(variaciones_2018_2012$variacion_pvem_presidencial_2018_2012, na.rm = T)
  mean(variaciones_2018_2012$variacion_pan_presidencial_2018_2012, na.rm = T)
  mean(variaciones_2018_2012$variacion_nva_a_presidencial_2018_2012, na.rm = T)
  
  class(variaciones_2018_2012$variacion_mc_presidencial_2018_2012)
  var(variaciones_2018_2012$variacion_pvem_presidencial_2018_2012)
  var(variaciones_2018_2012$variacion_pan_presidencial_2018_2012)
  var(variaciones_2018_2012$variacion_nva_a_presidencial_2018_2012)
    
  sd(data$var, na.rm=TRUE)

#_______________________________________________________________________________
# otras graficas extras
  ...
  pedersen_2018_2012 <- pedersen_2018_2012 %>% 
    select(  id_estado,
             ...
             pedersen_pt_presidencial_2018_2012,
             pedersen_mc_presidencial_2018_2012) %>% 
    mutate(llave = str_c(id_estado, "_", id_distrito))
  
  pedersen_2018_2012 <- pedersen_2018_2012%>% mutate(llave = str_c(id_estado, "_", id_distrito))
  ...
  ggplot(long_pedersen_2018_2012, aes(x = variable, y = value)) +            # Applying ggplot function
...
require(reshape2)
ggplot(data = melt(variaciones_2018_2012), aes(x=variable, y=value)) + geom_boxplot(aes(fill=variable))
...
pedersen_2018_2012 <- volatilidad_presidencial_2012_2018 %>% 
  select(id_estado,
         ...
         pedersen_pt_presidencial_2018_2012,
         pedersen_mc_presidencial_2018_2012) %>% 
  select(pedersen_pri_presidencial_2018_2012,
         pedersen_pan_presidencial_2018_2012,
         pedersen_prd_presidencial_2018_2012,
         pedersen_pvem_presidencial_2018_2012,
         pedersen_pt_presidencial_2018_2012,
...
require(reshape2)
ggplot(data = melt(pedersen_2018_2012), aes(x=variable, y=value)) + geom_boxplot(aes(fill=variable))
...
bp <- variaciones_2018_2012 %>% ggplot(aes(llave,variacion_mc_presidencial_2018_2012 )) 
bp
+ 
  ggplot(aes(variacion_mc_presidencial_2018_2012)) + geom_boxplot()

ggplot(data = variaciones_2018_2012, aes(x=variacion_mc_presidencial_2018_2012)) + geom_boxplot()
b0 <- variaciones_2018_2012 %>% ggplot(aes(variacion_mc_presidencial_2018_2012)) + geom_boxplot()
b1 <- b0 + geom_boxplot(aes(fill = variacion_mc_presidencial_2018_2012), alpha = 0.25)
b1 
b2 <- b1 + geom_jitter(aes(col = variacion_mc_presidencial_2018_2012), alpha = 0.5, width = 0.25) +  # adding data points
  geom_sina(aes(col = variacion_mc_presidencial_2018_2012))
b2
...
variacion_pt_presidencial_2018_2012 = (p_pt_2018 - p_pt_2012),
variacion_mc_presidencial_2018_2012 = (p_mc_2018 - p_mc_2012),
variacion_nva_a_presidencial_2018_2012 = (p_nva_a_2018 - p_mc_2012),



class(volatilidad_presidencial_2012_2018$por_vn_2018)

boxplot(volatilidad_presidencial_2012_2018$p_pan_2012)
boxplot(volatilidad_presidencial_2012_2018$p_pri_2012)
boxplot(volatilidad_presidencial_2012_2018$p_prd_2012)
boxplot(volatilidad_presidencial_2012_2018$p_pvem_2012)
boxplot(volatilidad_presidencial_2012_2018$p_pt_2012)
boxplot(volatilidad_presidencial_2012_2018$p_mc_2012)
boxplot(volatilidad_presidencial_2012_2018$p_nva_a_2012)

scatterplot(x = volatilidad_presidencial_2012_2018$variacion_pan_presidencial_2018_2012, y = volatilidad_presidencial_2012_2018$variacion_mc_presidencial_2018_2012)
scatterplot(x = volatilidad_presidencial_2012_2018$variacion_pvem_presidencial_2018_2012, y = volatilidad_presidencial_2012_2018$variacion_mc_presidencial_2018_2012)

scatterplot(x =volatilidad_presidencial_2012_2018$pedersen_pan_presidencial_2018_2012, y = volatilidad_presidencial_2012_2018$pedersen_mc_presidencial_2018_2012)
scatterplot(x = volatilidad_presidencial_2012_2018$variacion_pvem_presidencial_2018_2012, y = volatilidad_presidencial_2012_2018$variacion_mc_presidencial_2018_2012)

### base plot
b0 <- volatilidad_presidencial_2012_2018 %>% ggplot(aes(Months,Avg_temp))

boxplot(volatilidad_presidencial_2012_2018$variacion_pri_presidencial_2018_2012)
boxplot(volatilidad_presidencial_2012_2018$variacion_prd_presidencial_2018_2012)
boxplot(volatilidad_presidencial_2012_2018$variacion_pvem_presidencial_2018_2012)
boxplot(volatilidad_presidencial_2012_2018$variacion_pt_presidencial_2018_2012)
boxplot(volatilidad_presidencial_2012_2018$variacion_mc_presidencial_2018_2012)
boxplot(volatilidad_presidencial_2012_2018$variacion_nva_a_presidencial_2018_2012)



boxplot(variacion_presidencial_2012_2018$p_pan_2012)
boxplot(variacion_presidencial_2012_2018$p_pri_2012)
boxplot(variacion_presidencial_2012_2018$p_prd_2012)
boxplot(variacion_presidencial_2012_2018$p_pvem_2012)
boxplot(volatilidad_presidencial_2012_2018$p_pt_2012)
boxplot(volatilidad_presidencial_2012_2018$p_mc_2012)
boxplot(volatilidad_presidencial_2012_2018$p_nva_a_2012)


boxplot(volatilidad_presidencial_2012_2018$variacion_pan_presidencial_2018_2012)
boxplot(volatilidad_presidencial_2012_2018$variacion_pri_presidencial_2018_2012)
boxplot(volatilidad_presidencial_2012_2018$variacion_prd_presidencial_2018_2012)
boxplot(volatilidad_presidencial_2012_2018$variacion_pvem_presidencial_2018_2012)
boxplot(volatilidad_presidencial_2012_2018$variacion_pt_presidencial_2018_2012)
...
ggplot(volatilidad_presidencial_2012_2018, aes(x = variacion_mc_presidencial_2018_2012)) +                           # Basic ggplot2 histogram
  geom_histogram()+
  labs(title = "variacion mc presidencial 2018 2012",
       x = "Values",
       y = "Count of Values")+
...
boxplot(volatilidad_presidencial_2012_2018$p_pan_2018)
boxplot(volatilidad_presidencial_2012_2018$p_pri_2018)
boxplot(volatilidad_presidencial_2012_2018$p_prd_2018)
boxplot(volatilidad_presidencial_2012_2018$p_pvem_2018)
boxplot(volatilidad_presidencial_2012_2018$p_pt_2018)
boxplot(volatilidad_presidencial_2012_2018$p_mc_2018)
boxplot(volatilidad_presidencial_2012_2018$p_nva_a_2018)
boxplot(volatilidad_presidencial_2012_2018$p_pan_2018)

boxplot(volatilidad_presidencial_2012_2018$pedersen_pri_presidencial_2018_2012)
boxplot(volatilidad_presidencial_2012_2018$pedersen_pan_presidencial_2018_2012)
boxplot(volatilidad_presidencial_2012_2018$pedersen_prd_presidencial_2018_2012)
boxplot(volatilidad_presidencial_2012_2018$pedersen_pvem_presidencial_2018_2012)
boxplot(volatilidad_presidencial_2012_2018$pedersen_pt_presidencial_2018_2012)
boxplot 
...
boxplot(volatilidad_presidencial_2012_2018$pan_2012)
hist(volatilidad_presidencial_2012_2018$p_mc_2012)
hist(volatilidad_presidencial_2012_2018$p_pan_2012)

hist(volatilidad_presidencial_2012_2018$mc_2012, freq=F, breaks=12)
lines(density(volatilidad_presidencial_2012_2018$mc_2012), col="red")
lines(seq(-10, 10, by=.5), dnorm(seq(-10, 10, by=.5),
                                 mean(volatilidad_presidencial_2012_2018$mc_2012), sd(volatilidad_presidencial_2012_2018$mc_2012)), col="blue")

hist(volatilidad_presidencial_2012_2018$pan_2012, freq=F, breaks=12)
lines(density(volatilidad_presidencial_2012_2018$pan_2012), col="red")
lines(seq(-10, 10, by=.5), dnorm(seq(-10, 10, by=.5),
                                 mean(volatilidad_presidencial_2012_2018$pan_2012), sd(volatilidad_presidencial_2012_2018$pan_2012)), col="blue")
