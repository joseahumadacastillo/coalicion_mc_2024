...
barplot_2000 <- read.csv("barplot_2000.csv")
#load
...
T_2000 <- (((primero_2000 + segundo_2000)*(segundo_2000 - tercero_2000))/(primero_2000))
T_2000


barplot_2000 <- ggplot(barplot_2000, aes(Partido, dosmil, fill = Partido)) +
  geom_bar(stat="identity", width= .5) +
  scale_fill_manual(values=c("blue", "red", "yellow", "purple", "orange", "magenta3")) +
...
barplot_2006 <- read.csv("barplot_2006.csv")

barplot_2006$Partido <- factor(barplot_2006$Partido, levels = c("PAN", "PRI", "PRD", "NVA", "ASD"))
...
barplot_2006 <- ggplot(barplot_2006, aes(Partido, dosmilseis, fill = Partido)) +
  geom_bar(stat="identity", width= .5) +
  scale_fill_manual(values=c("blue", "yellow", "red", "deepskyblue4", "navyblue")) +
...
barplot_2012 <- ggplot(barplot_2012, aes(Partido, dosmildoce, fill = Partido)) +
  geom_bar(stat="identity", width= .5) +
  scale_fill_manual(values=c("red", "yellow", "blue", "deepskyblue4")) +
